...
import { formatDateString, isDateString } from '@/utils/helpers';
                ...
                return (
                  ...
                  >
                    {header.render
                      ...
                      ? header.key.includes('created') ||
                        header.key.includes('updated')
                        ? isDateString(value)
                ...
                <td className="px-6 py-4 whitespace-nowrap flex flex-row gap-3 mr-auto w-fit">
                  {handleOpenView && (
                    <button
                      ...
                      onClick={() =>
                        row && row.id ? handleOpenView(row.id) : undefined
                      }
                    >
                      <FaEye />
                    </button>
                  ...
                  {handleOpenEdit && (
                    <button
                      ...
                      onClick={() =>
                        row && row.id ? handleOpenEdit(row.id) : undefined
                      }
                    >
                      <FaPencil />
                    </button>
                  ...
                  {handleOpenDelete && (
                    <button
                      ...
                      onClick={() =>
                        row && row.id ? handleOpenDelete(row.id) : undefined
                      }
                    >
                      <FaTrash />
                    </button>
